...
Report bugs at https://github.com/histrio/tw-mirror/issues
...
https://github.com/histrio/tw-mirror/issues.
...
Ready to contribute? Here's how to set up `tw-mirror` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `tw-mirror` repo on GitHub.
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/tw-mirror.git
